...
module Bosh::Dev::Google
  class RunnerBuilder
    def build(artifacts, net_type)
      ...
      director_address = Bosh::Dev::Bat::DirectorAddress.from_env(env, 'BOSH_GOOGLE_MICROBOSH_IP')
      ...
      bat_deployment_manifest = BatDeploymentManifest.new(env, director_uuid, stemcell_archive)
